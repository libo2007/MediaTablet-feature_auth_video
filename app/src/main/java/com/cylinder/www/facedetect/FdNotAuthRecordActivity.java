...
public class FdNotAuthRecordActivity implements CvCameraViewListener2, IDataCenterNotify {
    ...
    private FdNotAuthRecordCameraView mOpenCvCameraView;
    ...
    public void onCreate(View view) {
        ...
        mOpenCvCameraView = (FdNotAuthRecordCameraView) view.findViewById(R.id.fdNotAuthCameraView);
